package com.ssafy.Dito.domain.log.appUsageEvent.entity;
...
public class AppUsageEvent extends IdentifiableEntity {
    ...
    private AppUsageEvent(String eventId, EventType eventType, String packageName,
    ...
    public static AppUsageEvent of(AppUsageEventReq req, User user) {
