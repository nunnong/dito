...
| **Backend/Infra** | 장아영 | Spring Boot 백엔드 API 개발<br/>PostgreSQL/MongoDB 데이터베이스 설계<br/>Docker Compose 기반 인프라 구축, CI/CD 파이프라인 |
...
### [Backend/Infra] 장아영
Jetpack Compose로 전체 UI를 구축하면서 선언형 UI의 편리함을 체감했습니다. Clean Architecture와 MVVM 패턴을 적용하여 각 레이어의 책임을 명확히 분리한 덕분에 유지보수가 쉬운 코드를 작성할 수 있었습니다. Accessibility Service를 활용한 앱 사용량 추적 기능은 Android 시스템의 깊은 이해가 필요했던 도전적인 과제였습니다. Hilt를 통한 의존성 주입은 테스트 가능한 코드 작성에 큰 도움이 되었고, 프로젝트 구조를 체계적으로 유지할 수 있었습니다.
